      ...
      <Layout>
        <div id="playPodCast" className="container-fluid">
          <div className="container mt-5">
            ...
            <Slider {...settings} >
              <div>
                <div className="sliderBox d-flex align-items-center  mt-3 gap-3 px-5 mx-5 ">
                  <img
                    className="img-fluid"
                    style={{ width: "350px" }}
                ...
                <div className="audiobox d-flex justify-content-center gap-1 px-5 mx-5 mt-4 text-white">
                  <span>0:00</span>
                  <input
                    type="range"
              ...
              <div>
                <div className="sliderBox d-flex align-items-center sm:flex-column mt-3 gap-3 px-5 mx-5 ">
                  <img
                    className="img-fluid"
                    style={{ width: "350px" }}
                    src="/images/UltimateLogo.png"
