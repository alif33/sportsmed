      ...
      <Layout>
        ...
        >
          <div className="infobox w-75 mx-auto my-4">
            <h1 className="fw-bold text-center mt-3">TERMS OF USE</h1>
            <p className="mb-4">Last updated May 11, 2020</p>
            <h4 className="mt-5">AGREEMENT TO TERMS</h4>
            <p className="lead mt-3">
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and SportsMedAnalytics ("Company", “we”, “us”, or “our”),
              concerning your access to and use of the
              http://sportsmedanalytics.com website as well as any other media
            ...
            <h4 className="mt-5">INTELLECTUAL PROPERTY RIGHTS</h4>
            <p className="lead mt-3">
            ...
            <h4 className="mt-5">USER REPRESENTATIONS</h4>
            <p className="lead mt-3">
            ...
            <h4 className="mt-5 ">PROHIBITED ACTIVITIES</h4>
            <p className="lead mt-3">
            ...
            <p className="lead">14. Sell or otherwise transfer your profile.</p>
            <p className="lead">
            ...
            <h5 className="mt-5">CONTRIBUTION LICENSE</h5>
            ...
            {/* SUBMISSIONS */}
            <h5 className="mt-5">SUBMISSIONS</h5>
            ...
            <h5 className="mt-5">THIRD-PARTY WEBSITE AND CONTENT</h5>
            <p className="lead mt-3">
            ...
            {/* ADVERTISERS */}
            <h5 className="mt-5">ADVERTISERS</h5>
            <p className="lead mt-3">
            ...
            {/* SITE MANAGEMENT */}
            <h5 className="mt-5">SITE MANAGEMENT</h5>
            <p className="lead mt-5">
            ...
            <h5 className="mt-5">TERM AND TERMINATION</h5>
            <p className="lead mt-3">
              These Terms of Use shall remain in full force and effect while you
              use the Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS
              OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND
            ...
            <h5 className="mt-5">MODIFICATIONS AND INTERRUPTIONS</h5>
            <p className="lead mt-3">
            ...
            {/* DISPUTE RESOLUTION */}
            <h5 className=" mt-5">DISPUTE RESOLUTION</h5>
            <p className="lead mt-3">
              ...
              San Mateo, California, and the Parties hereby consent to, and
            ...
            {/* CORRECTIONS */}
            <h5 className="mt-5">CORRECTIONS</h5>
            <p className="lead mt-3">
            ...
            <h5 className="mt-5">LIMITATIONS OF LIABILITY</h5>
            <p className="lead mt-5 fw-bold">
              ...
              CAUSE OF ACTION ARISING OR $50.00 USD. CERTAIN US STATE LAWS AND
            ...
            {/* INDEMNIFICATION */}
            <h5 className="mt-5">INDEMNIFICATION</h5>
            <p className="lead mt-3">
            ...
            {/* USER DATA */}
            <h5 className="mt-5">USER DATA</h5>
            <p className="lead mt-3">
            ...
            <h5 className="mt-5">CALIFORNIA USERS AND RESIDENTS</h5>
            <p className="lead mt-3">
            ...
            <p className="lead mt-5">SportsMedAnalytics</p>
            <p className="lead">United States</p>
            <p className="lead">chonasportsmed@gmail.com</p>
          </div>
        </div>
      </Layout>
    </>
