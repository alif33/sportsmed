                        ...
                        <div className='Navbar'>
                            <ul class="nav col-md-8 d-flex mb-2 justify-content-center mb-md-0 text-white flex-dirction-row">
                                ...
                                <div className='d-flex linkBox'>
                                    <li ><Link href="/nfl" class="nav-link px-2 text-white">NFL</Link></li>
                                    <li><Link href="/nba" class="nav-link px-2 text-white">NBA</Link></li>
                                    <li><Link href="/mlb" class="nav-link px-2 text-white">MLB</Link></li>
                                    <li><Link href="/watch" class="nav-link px-2 text-white">Watch</Link></li>
                                    <li><Link href="/podcast" class="nav-link px-2 text-white">Podcast</Link></li>
