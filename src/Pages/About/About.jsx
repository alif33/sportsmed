            ...
            <div id="about" data-aos="fade-in"
                ...
                <div className=' text-center text-white'>
                    <div className='mt-5 w-75 mx-auto lh-lg'>
                        <img src="/assets/images/about/profile.png" className='img-fluid' alt="profile" />
                        <h1 className='my-3 ' style={{ fontSize: "45px" }}>BACKGROUND</h1>
                        <p className="my-2">
