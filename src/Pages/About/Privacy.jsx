...
const Privacy = () => {
    return (
        <div id='displaimer' data-aos="fade-in"
            data-aos-easing="linear"
            data-aos-duration="1200">
            <div className="infobox w-75 mx-auto my-4">
                <h1 className='fw-bold text-center mt-3'>PRIVACY POLICY</h1>
                <p className="mb-4">Last updated May 11, 2020</p>
                <div className='lead '>
                    <p>Thank you for choosing to be part of our community at SportsMedAnalytics (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at chonasportsmed@gmail.com.</p>
                    <p>When you visit our website https://www.sportsmedanalytics.com/, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy policy, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it.</p>
                    <p>We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and our services.</p>
                    <p>This privacy policy applies to all information collected through our website (such as https://www.sportsmedanalytics.com/), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "Services").</p>
                    ...
                    <p>TABLE OF CONTENTS
                        ...
                        12. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</p>
                    <h4 className='mt-5'>1. WHAT INFORMATION DO WE COLLECT?</h4>
                    ...
                    <p>Publicly Available Personal Information. We collect email addresses; first name, maiden name, last name, and nickname; and other similar data.</p>
                    ...
                    <p>Information automatically collected

                        In Short:   Some information — such as IP address and/or browser and device characteristics — is collected automatically when you visit our Services.

                        We automatically collect certain information when you visit, use or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services and other technical information. This information is primarily needed to maintain the security and operation of our Services, and for our internal analytics and reporting purpose</p>

                    <h4 className='mt-5'>2. HOW DO WE USE YOUR INFORMATION?</h4>
                    ...
                    <h4 className='mt-5'>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h4>
                    ...
                    {/* 4. HOW DO WE HANDLE YOUR SOCIAL LOGINS? */}
                    <h4 className='mt-5'>4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h4>
                    ...
                    {/* 5 */}
                    <h4 className="mt-5">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h4>
                    ...
                    {/* 7. WHAT ARE YOUR PRIVACY RIGHTS? */}
                    <h4 className='mt-5'>7. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
                    ...
                    <p>A privacy breach occurs when there is unauthorized access to or collection, use, disclosure or disposal of personal information. You will be notified about data breaches when Sports Med Analytics believes you are likely to be at risk or serious harm. For example, a data breach may be likely to result in serious financial harm or harm to your mental or physical well-being. In the event that Sports Med Analytics becomes aware of a security breach which has resulted or may result in unauthorized access, use or disclosure of personal information Sports Med Analytics will promptly investigate the matter and notify the applicable Supervisory Authority not later than 72 hours after having become aware of it, unless the personal data breach is unlikely to result in a risk to the rights and freedoms of natural persons.</p>

                    <h4 className="mt-5">9. CONTROLS FOR DO-NOT-TRACK FEATURES</h4>
                    ...
                    <h4 className="mt-5">10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h4>
                    ...
                    <h4 className="mt-5">11. DO WE MAKE UPDATES TO THIS POLICY?</h4>
                    <p>We may update this privacy policy from time to time. The updated version will be indicated by an updated “Revised” date and the updated version will be effective as soon as it is accessible. If we make material changes to this privacy policy, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification. We encourage you to review this privacy policy frequently to be informed of how we are protecting your information.</p>
                    <h4 className="mt-5">12. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h4>
                    <p>If you have questions or comments about this policy, you may contact our Data Protection Officer (DPO), Mayank Bishnoi, by email at chonasportsmed@gmail.com,</p>

                    <h4 className="mt-5">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h4>
